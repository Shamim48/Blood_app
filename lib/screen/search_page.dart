                ...
                child: DropdownButton<DivisionModel>(
                  ...
                  hint: Text('Select Division',
                      style: LatoRegular.copyWith(
                          color: ColorResources.BLACK,
                          fontSize: Dimensions.FONT_SIZE_DEFAULT)),
                  value: divisionProvider.divisionPosition == -1 ? null : divisionProvider
                      .divisionList![divisionProvider.divisionPosition],
                  ...
                  onChanged: (DivisionModel? divisionData){
                    ...
                    Provider.of<DistrictProvider>(context, listen: false).setDistrictPosition(-1);
                    Provider.of<DistrictProvider>(context, listen: false).getDistrictList(divisionData.id);
      ...
      child: Column(
        ...
        children: [
          ...
          Consumer<DistrictProvider>(
            ...
            districtProvider.districtList != null ? districtProvider.districtList!.length > 0 ? Container(
                height: 40,
                padding: EdgeInsets.only(left: 15),
                decoration: textFieldDecoration(),
                child: DropdownButton<DistrictsModel>(
                  ...
                  hint: Text('Select District',
                      style: LatoRegular.copyWith(
                          color: ColorResources.BLACK,
                          fontSize: Dimensions.FONT_SIZE_DEFAULT)),
                  value: districtProvider.districtPossition == -1 ? null : districtProvider
                      .districtList![districtProvider.districtPossition],
                  items: districtProvider.districtList!.map((
                  ...
                  onChanged: (DistrictsModel? disData){
                    int index = districtProvider.districtList!.indexOf(disData!);
                    districtProvider.setDistrictPosition(index);
                    districtProvider.setDistrictId(disData.id);
